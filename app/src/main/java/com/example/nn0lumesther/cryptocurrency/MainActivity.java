...
import com.example.nn0lumesther.cryptocurrency.Rates.CashRate;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestUrl = "https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH&tsyms=" +
                "NGN,USD,EUR,AUD,JPY,TWD,GBP,RUB,ARS,INR,JBY,LRD,MXN,BRL,CAD,ZAR,ILS,MYR,SEK,NZD"; //Currencies will NOT be displayed in this here order
    ...
    private class MyAdapter extends BaseAdapter {
        ArrayList<CashRate> rates;

        private MyAdapter(ArrayList<CashRate> ratesInstance) {
            rates = ratesInstance;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            ViewHolder holder;
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.list_format, parent, false);
            ...
            final CashRate rateRow = rates.get(position);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            while(keysBTC.hasNext() && keysETH.hasNext()) {
                                ...
                                rates.add(keyBTC, btc_rates.getDouble(keyBTC), eth_rates.getDouble(keyETH));
                            }

                            mSwipeRefreshLayout.setRefreshing(false); //to remove the progress bar for refresh
                            rates.orderList(orderMode);
                            ratesListView.setAdapter(new MyAdapter(rates.ratesArrayList));
